    ...
    <section className="py-12 sm:py-16 md:py-20 px-4 bg-gradient-to-br from-[#4DB8BA] via-[#5bc3c5] to-[#6bcfd1]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
          <Button
            onClick={onShowAuth}
            className="w-full sm:w-auto bg-white hover:bg-gray-100 text-[#4DB8BA] font-bold px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 text-sm sm:text-base md:text-lg rounded-full shadow-2xl hover:shadow-white/50 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
          >
            Start a Trip
